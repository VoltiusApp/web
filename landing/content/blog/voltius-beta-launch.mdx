...
- Import existing data from supported sources. Read more in [Import and Export Your SSH Workspace in Voltius](/blog/import-export-ssh-workspace).
- Local-first encrypted storage.
- Optional end-to-end encrypted sync. See [Local-First SSH with End-to-End Encrypted Sync](/blog/local-first-e2ee-sync) for the sync model.
...
For file transfer workflows, the SFTP experience is covered in more detail in [SFTP Workflows Beyond Local File Transfers](/blog/sftp-host-to-host-workflows).
