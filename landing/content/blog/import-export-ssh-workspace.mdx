...
If you want to sync the encrypted workspace between devices instead of moving export files manually, read [Local-First SSH with End-to-End Encrypted Sync](/blog/local-first-e2ee-sync).
...
This same local-first direction is introduced in the [Voltius beta launch post](/blog/voltius-beta-launch).
