...
description: "How Voltius handles local encrypted vaults, free encrypted Gist sync, and paid cloud sync without making an account mandatory."
date: "2026-06-02"
...
For one-off backups or migrations instead of continuous sync, see [Import and Export Your SSH Workspace in Voltius](/changelog/import-export-ssh-workspace).
