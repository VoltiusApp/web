...
For the product-level SFTP workflow, start with [SFTP Workflows Beyond Local File Transfers](/changelog/sftp-host-to-host-workflows).

<video poster="/changelog/sftp-tar-acceleration-poster.jpg">
  <source src="/changelog/sftp-tar-acceleration-demo.mp4" type="video/mp4" />
</video>
