---
title: "Voltius Beta: A Local-First SSH Client Built with Rust and Tauri"
description: "Voltius beta is live with SSH, SFTP, serial sessions, local-first encryption, plugin support, and no account required."
date: "2026-06-04"
category: "Release"
version: "v0.1.0-beta"
tags:
...
<video poster="/changelog/voltius-beta-launch-poster.jpg">
  <source src="/changelog/voltius-beta-launch-demo.mp4" type="video/mp4" />
</video>
...
- Import existing data from supported sources. Read more in [Import and Export Your SSH Workspace in Voltius](/changelog/import-export-ssh-workspace).
- Local-first encrypted storage.
- Optional end-to-end encrypted sync. See [Local-First SSH with End-to-End Encrypted Sync](/changelog/local-first-e2ee-sync) for the sync model.
...
For file transfer workflows, the SFTP experience is covered in more detail in [SFTP Workflows Beyond Local File Transfers](/changelog/sftp-host-to-host-workflows).

![Voltius workspace showing terminal panes, SFTP, and infrastructure tools](/changelog/voltius-beta-workspace.jpg)
